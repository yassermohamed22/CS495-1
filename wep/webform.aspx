    ...
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:Calendar ID="Calendar1" runat="server" CellPadding="0" Height="16px" Width="266px"></asp:Calendar>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label7" runat="server" Text="Phone Numper :"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label10" runat="server" Text="Re Password :"></asp:Label>
                </td>
                <td>
